...
SPEC = importlib.util.spec_from_file_location("verify_phase2", TOOLCHAIN / "verify_phase2.py")
...
class Phase2CompletionTest(unittest.TestCase):
    ...
    def test_canonical_phase2_completion_passes(self):
    ...
    def test_phase3_authorization_fails(self):
        completion = copy.deepcopy(self.values[0])
        completion["outcome"]["summary"] = "Phase 3 authorized"
