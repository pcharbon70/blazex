...
This executable profile composes BlazeX core, the semantic UI tree, renderer
contracts, the headless renderer, and test support without a browser or server
framework.
