...
# BH-04 activation assets

## Purpose

Source-bound Phase 1 governance, not renderer implementation or support evidence.

## What belongs here

Versioned authorization, entry, activation and completion artifacts. Predecessor
artifacts are immutable; inherited limitations retain their original state.
