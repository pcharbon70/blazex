...
- [`test_validate_bh03_activation.py`](test_validate_bh03_activation.py) — focused BH-03 Phase 1 authority, handoff, lifecycle vocabulary, boundary, dependency, empty-evidence, and overclaim tests
...
- [`validate_bh03_activation.py`](validate_bh03_activation.py) — fail-closed BH-03 Phase 1 authorization, accepted-handoff, lifecycle-contract, repository-activation, dependency, and empty-evidence checks
