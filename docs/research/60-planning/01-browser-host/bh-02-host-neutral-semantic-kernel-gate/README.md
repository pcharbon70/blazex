...
BH-02 and Phase 8 completed on 2026-09-05 with an
accepted-with-bounded-conditions decision. The internal versioned contract
baseline is accepted, while public APIs remain experimental and product
support remains unsupported. BH-03 is eligible but not authorized. The
completed gates
...
evidence](phase-04-implementation-evidence.md), [Phase 5 implementation
evidence](phase-05-implementation-evidence.md), and [Phase 6 implementation
evidence](phase-06-implementation-evidence.md), and [Phase 7 implementation
evidence](phase-07-implementation-evidence.md). Final evidence is in the
...
| [8 — Cross-Backend Reconciliation and BH-02 Acceptance](phase-08-cross-backend-reconciliation-and-bh-02-acceptance.md) | complete — accepted with bounded conditions | Resolve semantic leaks, review every required output and condition, and accept, revise, or block later framework work. | Phases 6–7 |
...
- [Phase 6 — Standalone DOM Lowering and Browser Conformance](phase-06-standalone-dom-lowering-and-browser-conformance.md)
