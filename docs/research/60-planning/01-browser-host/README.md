...
- [BH-07 — Phoenix Integration and Trusted Command Boundary](bh-07-phoenix-integration-and-trusted-command-boundary/README.md) — Phases 1–5 complete through typed, authorized, non-executing command admission; LiveView and LocalLiveView remain deferred.
