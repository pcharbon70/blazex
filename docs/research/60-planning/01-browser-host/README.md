...
- [BH-07 — Phoenix Integration and Trusted Command Boundary](bh-07-phoenix-integration-and-trusted-command-boundary/README.md) — Phases 1–4 complete; Phase 5 active for typed, authorized, non-executing command admission; LiveView and LocalLiveView remain deferred.
