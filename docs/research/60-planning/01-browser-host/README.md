...
- [BH-07 — Phoenix Integration and Trusted Command Boundary](bh-07-phoenix-integration-and-trusted-command-boundary/README.md) — Phase 1 complete; Phase 2 active for a public bootstrap envelope; LiveView and LocalLiveView remain deferred.
