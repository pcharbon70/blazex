...
bounded development. BH-06 Phases 1–4 complete the continuous browser-Wasm
slice, reachability, client-safety, exact compatibility, and secret-exclusion gates; later
build-pipeline work remains separately unauthorized.
...
- [BH-06 — Build, Compatibility, and Client-Safety Pipeline](bh-06-build-compatibility-and-client-safety-pipeline/README.md) — Phases 1–5 accepted through secret-bearing input exclusion; no release or support promotion.
