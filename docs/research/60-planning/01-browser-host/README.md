...
- [BH-07 — Phoenix Integration and Trusted Command Boundary](bh-07-phoenix-integration-and-trusted-command-boundary/README.md) — Phases 1–4 complete through session-bound CSRF and canonical origin enforcement; LiveView and LocalLiveView remain deferred.
