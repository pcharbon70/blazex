...
- [BH-07 — Phoenix Integration and Trusted Command Boundary](bh-07-phoenix-integration-and-trusted-command-boundary/README.md) — Phases 1–3 complete through bounded opaque sessions and redacted authentication projection; LiveView and LocalLiveView remain deferred.
