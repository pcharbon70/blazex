...
semantic-node, identity, and component-evaluation work is active, while later
...
- [BH-02 — Host-Neutral Semantic Kernel Gate](bh-02-host-neutral-semantic-kernel-gate/README.md) — eight-phase contract and cross-renderer proof plan; Phase 1 is complete and Phase 2 is explicitly authorized and active.
