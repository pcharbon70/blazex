...
- [BH-07 — Phoenix Integration and Trusted Command Boundary](bh-07-phoenix-integration-and-trusted-command-boundary/README.md) — Phases 1–2 complete; Phase 3 active for opaque sessions and redacted authentication projection; LiveView and LocalLiveView remain deferred.
