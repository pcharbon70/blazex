...
- [BH-07 — Phoenix Integration and Trusted Command Boundary](bh-07-phoenix-integration-and-trusted-command-boundary/README.md) — Phases 1–6 complete; Phase 7 is active for authenticated counter push/resynchronization while LiveView and LocalLiveView remain deferred.
