...
- [BH-07 — Phoenix Integration and Trusted Command Boundary](bh-07-phoenix-integration-and-trusted-command-boundary/README.md) — Phases 1–6 complete through one atomic trusted counter command; generalized handlers, LiveView, and LocalLiveView remain deferred.
