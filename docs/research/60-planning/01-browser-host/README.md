...
- [BH-07 — Phoenix Integration and Trusted Command Boundary](bh-07-phoenix-integration-and-trusted-command-boundary/README.md) — Phases 1–2 complete through the public bootstrap envelope; LiveView and LocalLiveView remain deferred.
