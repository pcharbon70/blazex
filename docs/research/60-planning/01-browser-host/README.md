...
and its portable presentation-intent work is active; later work retains its own
approval boundary.
...
- [BH-02 — Host-Neutral Semantic Kernel Gate](bh-02-host-neutral-semantic-kernel-gate/README.md) — eight-phase contract and cross-renderer proof plan; Phases 1–3 are complete and Phase 4 is explicitly authorized and active.
