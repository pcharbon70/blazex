...
- [BH-07 — Phoenix Integration and Trusted Command Boundary](bh-07-phoenix-integration-and-trusted-command-boundary/README.md) — Phases 1–7 complete through authenticated counter push/resynchronization; LiveView and LocalLiveView remain deferred.
