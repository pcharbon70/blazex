...
- [BH-07 — Phoenix Integration and Trusted Command Boundary](bh-07-phoenix-integration-and-trusted-command-boundary/README.md) — Phases 1–3 complete; Phase 4 active for session-bound CSRF and canonical origin enforcement; LiveView and LocalLiveView remain deferred.
