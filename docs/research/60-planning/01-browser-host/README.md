...
Phase 14 is authorized to compact exact cleanup outcomes and requalify the
unchanged Firefox gate; BH-06 remains ineligible.
...
- [BH-05 — Component Programming Model and Lifecycle](bh-05-component-programming-model-and-lifecycle/README.md) — Phase 13 completed with `revise`; corrective Phase 14 is authorized, and BH-06 remains ineligible. No support promotion is claimed.
