...
- [BH-07 — Phoenix Integration and Trusted Command Boundary](bh-07-phoenix-integration-and-trusted-command-boundary/README.md) — Phases 1–5 complete; Phase 6 is active for one atomic trusted counter command while LiveView and LocalLiveView remain deferred.
