...
slice, reachability, client-safety, and exact compatibility gates; later
...
- [BH-06 — Build, Compatibility, and Client-Safety Pipeline](bh-06-build-compatibility-and-client-safety-pipeline/README.md) — Phases 1–4 accepted through exact runtime compatibility; no release or support promotion.
