...
bundle-load handoff, and correlated readiness gate on 2026-09-06. Phase 4 is
explicitly authorized and active as of 2026-09-06. Shared-runtime reuse and
independent root lifecycle are the only newly authorized behaviors; shutdown,
runtime loss, retry, and fallback remain reserved for Phase 5.
...
| [4 — Shared Runtime Registry and Independent Root Lifecycle](phase-04-shared-runtime-registry-and-independent-root-lifecycle.md) | active — explicitly authorized | Reuse one compatible runtime while roots register, mount, update, move, dispose, and remount independently. | Phase 3 |
