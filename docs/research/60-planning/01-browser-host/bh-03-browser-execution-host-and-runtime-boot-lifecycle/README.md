...
| [7 — Resource, Reliability, and Startup Measurements](phase-07-resource-reliability-and-startup-measurements.md) | active — Section 7.1 complete | Measure root counts, readiness, memory growth, cleanup, repetition, and declared failure scenarios without promoting release budgets. | Phase 6 |
