...
| [7 — Resource, Reliability, and Startup Measurements](phase-07-resource-reliability-and-startup-measurements.md) | active — Sections 7.1–7.3 complete | Measured repeated startup, ten-root lifecycle cleanup, declared failures, and capability-aware memory observations in active Linux Chrome and Firefox without release budgets. | Phase 6 |
