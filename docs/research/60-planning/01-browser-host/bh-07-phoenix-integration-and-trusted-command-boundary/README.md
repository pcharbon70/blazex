...
| [6 — Atomic Trusted Command Execution](phase-06-atomic-trusted-command-execution.md) | active | Execute one closed counter mutation against server-owned revision state with exact replay and bounded redacted audit. | Accepted Phase 5 and explicit authorization |
