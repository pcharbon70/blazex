...
| [4 — Disposition, Capability, Fallback, and Portability Classification](phase-04-disposition-capability-fallback-and-portability-classification.md) | in progress | Assign every family a BlazeX disposition, delivery tier, package owner, capability contract, fallback, and backend-portability status. | Phase 3 |
