...
| [16 — Factorized Distribution Shape and Sparse Cleanup Outcomes](phase-16-factorized-distribution-shape-and-sparse-cleanup-outcomes.md) | active | Isolate every combined-maximum axis, remove completed owner graphs from retained outcome pages, and requalify Firefox without weakening the gate. | Phase 15 `revise` and explicit authorization |
