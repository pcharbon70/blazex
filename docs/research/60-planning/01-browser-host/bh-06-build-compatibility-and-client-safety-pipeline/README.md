...
| [11 — Entrypoint Accounting and Milestone Handoff](phase-11-entrypoint-accounting-and-milestone-handoff.md) | active | Produce a deterministic per-entrypoint attestation across artifacts, safety, compatibility, licenses, payload, closure, and integrity, then reconcile BH-06 completion. | Phase 10 and explicit authorization |
...
- [Phase 9 — Audited Runtime Closure Reduction](phase-09-audited-runtime-closure-reduction.md)
