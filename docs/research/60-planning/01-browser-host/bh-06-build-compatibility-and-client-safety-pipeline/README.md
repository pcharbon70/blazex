...
| [3 — Server and Native Client-Safety Gate](phase-03-server-native-client-safety-gate.md) | active | Classify every reachable and external dependency exactly, then reject server-only, native, unknown, and forbidden runtime primitives before bundle assembly. | Phase 2 and explicit authorization |
