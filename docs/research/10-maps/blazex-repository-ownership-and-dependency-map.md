...
| `blazex_host_browser` | browser execution-host lifecycle and concrete Web API capability provider | `blazex_core`, `blazex_effects`, runtime-facing host contracts | portable component logic, Phoenix/Plug requirement, server authorization |
