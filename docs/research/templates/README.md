...
Templates provide consistent starting points for completed archive documents
...
Update this page whenever a template is added, renamed, or changed. Keep
metadata aligned with [`frontmatter.schema.json`](../frontmatter.schema.json)
and guidance aligned with [`AGENTS.md`](../AGENTS.md).
