...
import { compare } from "./conformance-scenarios.js";
const rows = [];
...
for (const row of rows) {
  ...
  if (expected.length) for (const mutate of [a => a.pop(), a => a[0].text = "wrong", a => a[0].attributes["data-bx-kind"] = "wrong", a => a[0].tag = "wrong", a => a[0].children.push("missing")]) {
