...
- [Phase 17 append-only release-ticket attempt ledger](provider-release-ticket-attempts-v0.1.0.json) — Retains every architecture probe, the nonqualifying diagnostic deadline relaxation, active-runtime results, artifact identities, and the truthful revise decision.
- [Phase 18 compact-ticket acknowledgement attempt ledger](compact-ticket-acknowledgement-attempts-v0.1.0.json) — Records the provider-authorized scalar-success correction, unchanged deadline matrix, acknowledgement counters, active-runtime results, and accepted reconciliation.
