import { EVENT_MAPPINGS, INTERACTION_PROTOCOL, listenerIdentity, normalizeNative, requireInteraction, validateInteraction, interactionDiagnostic } from "./interaction-record.js";
...
export class InteractionListeners {
  ...
  publish(transaction) {
    ...
    this.#receiver.setContext({ ...this.#context, listeners: [...this.#bindings.keys()] }); this.#observations.clear(); this.resume();
  }
